...
const NlotSchema = new mongoose.Schema({
...
const PfiniSchema = new mongoose.Schema({
...
PfiniSchema.pre("save", function(next) {
...
const PfiniModel = mongoose.model("Pfini", PfiniSchema);
const NlotModel = mongoose.model("Nlot", NlotSchema);

module.exports = { PfiniModel, NlotModel };
